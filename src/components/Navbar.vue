      ...
      <div class="container flex flex-wrap items-center justify-between">
        ...
        <div class="flex items-center lg:order-2 ml-auto lg:ml-0 relative">
          ...
          <div ref="navFavBtn" class="relative" @click.stop="toggleFav">
            ...
            />
            <!-- badge -->
            <div class="absolute inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-warm border-2 border-white rounded-full -top-2 -right-2 cursor-pointer">20</div>
            <!-- favorite menu -->
            <div ref="navFav" class="w-[240px] sm:w-[360px] z-10 hidden rounded-md shadow absolute top-[72px] -right-36 backdrop-opacity-[2px] border border-white/38 bg-dark" @click.stop="toggleFav">
              <div class="p-2 bg-white/10">
                <ul class="text-sm text-white">
                  <li>
                    <div class="flex py-2 border-b border-dashed">
                      <div class="basis-1/6 ml-2 hidden sm:flex justify-center items-center">
                        <img src="../images/products/Meta_Oculus_Quest2.jpg" class="w-14 h-14 object-cover">
                      </div>
                      <div class="flex flex-col flex-1 h-14 ml-2 justify-between overflow-hidden">
                        <p class="basis text-left font-bold whitespace-nowrap truncate">Oculus Quest 2 256G</p>
                        <p class="basis text-gray-300 text-left">NT$ 17,500</p>
                      </div>
                      <div class="basis-1/12 flex justify-center items-center mx-1">
                        <font-awesome-icon
                          :icon="['fas', 'xmark']"
                          size="2x"
                  ...
                  <li>
                    <div class="flex py-2 border-b border-dashed">
                      <div class="basis-1/6 ml-2 hidden sm:flex justify-center items-center">
                        <img src="../images/products/VIVE_XR_Elite.jpg" class="w-14 h-14 object-cover">
                      </div>
                      <div class="flex flex-col flex-1 h-14 ml-2 justify-between overflow-hidden">
                        <p class="basis text-left font-bold whitespace-nowrap truncate">XR Elite</p>
          ...
          <div ref="navCartBtn" class="ml-8 relative" @click.stop="toggleCart">
            ...
            <div class="absolute inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-warm border-2 border-white rounded-full -top-2 -right-2 cursor-pointer">20</div>
            <!-- cart menu -->
            <div ref="navCart" class="w-[240px] sm:w-[360px] z-10 hidden rounded-md shadow absolute top-[72px] -right-20 backdrop-opacity-[2px] border border-white/38 bg-dark" @click.stop="toggleCart">
              <div class="p-2 bg-white/10">
                <ul class="text-sm text-white">
                  <li>
                    <div class="flex py-2 border-b border-dashed">
                      ...
                      <div class="flex flex-col flex-1 h-14 ml-2 justify-between overflow-hidden">
                        <p class="basis text-left font-bold whitespace-nowrap truncate">Oculus Quest 2 256G</p>
                        <div class="flex justify-between items-end text-gray-300">
                          <p class="flex-1 text-left">NT$ 34,300</p>
                          <div class="flex items-end">
                            <span>數量：</span>
                            <input type="number" min="1" max="99" value="1" class="rounded text-sm text-dark text-right h-6 w-14 mr-1">
                          </div>
                        </div>
                      </div>
                      <div class="basis-1/12 flex justify-center items-center mx-1">
                  ...
                  <li>
                    <div class="flex py-2 border-b border-dashed">
                      ...
                      <div class="flex flex-col flex-1 h-14 ml-2 justify-between overflow-hidden">
                        <p class="basis text-left font-bold whitespace-nowrap truncate">XR Elite</p>
                        <div class="flex flex-row justify-between items-end text-gray-300">
                          <p class="flex-1 text-left">NT$ 34,300</p>
                          <div class="flex items-end">
                            <span>數量：</span>
                            <input type="number" min="1" max="99" value="1" class="rounded text-sm text-dark text-right h-6 w-14 mr-1">
...
export default {
  ...
  mounted() {
    ...
    const { navMenu, navBtn, navCart, navCartBtn, navFav, navFavBtn } = this.$refs;
    const navOptions = {
      onExpand: () => {
