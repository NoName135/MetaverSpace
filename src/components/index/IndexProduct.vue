      ...
      <div class="m-0 lg:-mx-[25%]">
        ...
        >
          <swiper-slide class="rounded border overflow-hidden">
            <div class="h-full">
              <a href="#">
                <img class="h-1/2 md:h-3/5 w-full object-cover relative" src="../../images/products/Meta_Oculus_Quest2.jpg" alt="" />
                <div class="absolute top-2 left-3 sm:top-4 sm:left-6">
                  <div class="flex items-center">
                    <div class="bg-dark px-2 py-1 rounded-sm text-white text-xs mr-1">Meta</div>
              ...
              <div class="p-3 md:p-5 h-1/2 md:h-2/5 flex flex-col justify-between" style="background: linear-gradient(142.88deg, rgba(255, 255, 255, 0.16) 8.09%, rgba(255, 255, 255, 0.064) 27.24%, rgba(255, 255, 255, 0.064) 34.42%, rgba(255, 255, 255, 0.1088) 48.78%, rgba(255, 255, 255, 0) 100%);">
                <div class="md:flex justify-between text-white">
                  <div>
                    <div class="text-left">
                      <h5 class="text-lg font-bold mb-2">Oculus Quest 2 256G</h5>
                      <p class="text-sm ellipse2 mb-2 md:mb-0">硬體全面升級，易於設定且能安心使用。</p>
                    </div>
                  </div>
                  <div class="whitespace-nowrap mb-2 md:mb-0 md:ml-2">
                    <div class="block text-left xs:flex justify-between items-center md:block md:text-right">
                      <p class="text-gray-400 line-through md:mb-2">NT$ 17,980</p>
                      <p class="text-lg font-bold">NT$ 17,500</p>
                    </div>
                  </div>
                </div>
                <div class="md:flex justify-between items-center">
                  <button type="button" class="primary-button w-full md:max-w-[112px] mb-2 md:mb-0">加入購物車</button>
          ...
          <swiper-slide class="rounded border overflow-hidden">
            <div class="h-full">
              <a href="#">
                <img class="h-1/2 md:h-3/5 w-full object-cover relative" src="../../images/products/VIVE_XR_Elite.jpg" alt="" />
                <div class="absolute top-2 left-3 sm:top-4 sm:left-6">
                  <div class="flex items-center">
                    <div class="bg-dark px-2 py-1 rounded-sm text-white text-xs mr-1">VIVE</div>
                    <div class="bg-dark p-[1px] rounded-sm text-xs">
                ...
                <div class="md:flex justify-between text-white">
                  <div>
                    <div class="text-left">
                      ...
                      <p class="hidden xs:block text-sm ellipse2 mb-2 md:mb-0">舒適配戴，享受一體機的無線自由。更能透過無線串流，釋放 PC VR 的強大潛能。</p>
                    </div>
                  </div>
                  <div class="whitespace-nowrap mb-2 md:mb-0 md:ml-2">
                    <div class="block text-left xs:flex justify-between items-center md:block md:text-right">
                      <p class="text-gray-400 line-through md:mb-2">NT$ 34,500</p>
    ...
    <div ref="other" class="mt-16 grid grid-cols-1 md:grid-cols-2 mx-2 lg:mx-0 gap-6 md:gap-0 overflow-x-hidden">
      ...
      <div ref="other2" class="p-10 bg-cover bg-center border border-opacity-87" :style="{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),url(${subscribe})`}">
        ...
        <div class="relative w-full">
          ...
          <input type="text" class="mt-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary0 focus:border-primary0 block w-full pl-10 p-2.5" placeholder="Email">
        </div>
        <div class="mt-16">
