    ...
    <div class="container py-24">
      ...
      <div ref="timeline1" class="timeline overflow-hidden">
        ...
        <div class="flex flex-wrap justify-around lg:flex-row-reverse mx-4">
          <div
            ref="timeline1Image"
            class="basis-full lg:basis-2/5 bg-cover bg-center h-[460px] lg:h-[600px] rounded"
            :style="{
              backgroundImage: `linear-gradient(180deg, rgba(21, 20, 23, 0) 73.01%, #151417 89.8%), url(${categories.AR})`,
            }"
          ></div>
          <div
            ref="timeline1Text"
            class="basis-full lg:basis-2/5 flex flex-col justify-center mb-16 lg:mb-0"
          >
        ...
        <p
          ref="timeline1Title"
          class="text-8xl xl:text-9xl font-bold text-center text-white/20 -mt-32 hidden lg:block"
        >
          Augmented Reality
        </p>
      </div>
      <div ref="timeline2" class="timeline overflow-hidden">
        ...
        <div class="flex flex-wrap justify-around mx-4">
          <div
            ref="timeline2Image"
            class="basis-full lg:basis-2/5 bg-cover bg-left h-[460px] lg:h-[600px] rounded"
            :style="{
              backgroundImage: `linear-gradient(180deg, rgba(21, 20, 23, 0) 73.01%, #151417 89.8%), url(${categories.VR})`,
            }"
          ></div>
          <div
            ref="timeline2Text"
          ...
          >
            ...
            <RouterLink
              :to="{ name: '商品列表', query: { category: 'VR' } }"
              class="w-24 primary-button"
              >前往購買</RouterLink
            >
          </div>
      ...
      <div ref="timeline3" class="timeline overflow-hidden">
        ...
        <div class="flex flex-wrap justify-around lg:flex-row-reverse mx-4">
          <div
            ...
            class="basis-full lg:basis-2/5 bg-cover bg-center h-[460px] lg:h-[600px] rounded"
            :style="{
              backgroundImage: `linear-gradient(180deg, rgba(21, 20, 23, 0) 73.01%, #151417 89.8%), url(${categories.MR})`,
            }"
          ></div>
          <div
            ref="timeline3Text"
          ...
          >
            ...
            <RouterLink
              :to="{ name: '商品列表', query: { category: 'MR' } }"
              class="w-24 primary-button"
              >前往購買</RouterLink
            >
          </div>
      ...
      <div ref="timeline4" class="timeline overflow-hidden">
        ...
        <div class="flex flex-wrap justify-around mx-4">
          <div
            ...
            class="basis-full lg:basis-2/5 bg-cover bg-center h-[460px] lg:h-[600px] rounded"
            :style="{
              backgroundImage: `linear-gradient(180deg, rgba(21, 20, 23, 0) 73.01%, #151417 89.8%), url(${categories.XR})`,
            }"
          ></div>
          <div
            ref="timeline4Text"
            class="basis-full lg:basis-2/5 flex flex-col justify-center"
          >
            <h3 class="text-xl text-primary font-bold mb-4">
              延展實境 XR（Extended Reality）
            </h3>
            <p class="mb-12">
              結合了實境和虛擬環境以及人機互動設備。其中可能包括了擴增實境(AR)、虛擬實境(VR)、混合實境(MR)，以及在這些之類的區域。
            </p>
            <RouterLink
              :to="{ name: '商品列表', query: { category: 'XR' } }"
              class="w-24 primary-button"
              >前往購買</RouterLink
            >
          </div>
