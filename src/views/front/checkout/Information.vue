          ...
          <div class="px-8">
            <div class="py-8 grid grid-cols-5 gap-6">
              <img
                ...
                alt=""
                class="hidden md:flex self-center w-full h-24 xl:h-32 object-cover rounded"
              />
              <div
                class="col-span-full md:col-span-4 flex flex-col justify-between"
              >
                <h2 class="text-lg xl:text-xl">Meta</h2>
                <h3 class="text-xl xl:text-2xl mt-2 lg:mt-3">
                  Oculus Quest 2 256G
                </h3>
                <div>
                  <div class="md:flex justify-between items-center mt-2">
                    <div
                      class="flex flex-row justify-between md:justify-start mt-4 md:mt-1 text-md xl:text-lg"
                    >
                      <p>規格：無</p>
                      <p class="md:ml-4">數量：1</p>
                    </div>
                    <h5 class="text-lg xl:text-xl mt-4 md:mt-0 text-end">
            ...
            <div class="py-8 grid grid-cols-5 gap-6 border-t">
              <img
              ...
              <div
                class="col-span-full md:col-span-4 flex flex-col justify-between"
              >
                <h2 class="text-lg xl:text-xl">VIVE</h2>
                <h3 class="text-xl xl:text-2xl mt-2 lg:mt-3">XR_ELITE</h3>
                <div>
                  <div class="md:flex justify-between items-center mt-2">
                    <div
                      class="flex flex-row justify-between md:justify-start mt-4 md:mt-1 text-md xl:text-lg"
            ...
            <div class="flex flex-col items-end py-6 border-t">
              ...
              <h5 class="mt-4 text-warm text-lg xl:text-xl">
                折扣：<span class="font-bold">NT$ 1,000</span>
              </h5>
              <h3 class="mt-4 text-primary0 text-xl xl:text-2xl text-end">
...
export default {
  methods: {
    nextStep() {
      this.$router.replace("/checkout/check/id");
    },
  },
  mounted() {
