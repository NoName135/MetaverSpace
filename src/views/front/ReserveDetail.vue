        ...
        <table class="w-full text-sm text-left">
          <thead class="uppercase bg-white/20 text-gray-300">
            <tr>
              ...
              <th scope="col" class="px-6 py-3 whitespace-nowrap">預約人數</th>
              <th scope="col" class="px-4 py-3 whitespace-nowrap">門市</th>
          ...
          <tbody class="text-md text-gray-400">
            <tr class="border-b bg-gray-800 border-gray-700">
              ...
              >
                2023/01/29<span class="ml-2">15:00</span>
              </th>
              <td class="px-6 py-4 whitespace-nowrap">台中館</td>
              <td class="px-4 py-4 whitespace-nowrap">2</td>
              <td class="px-6 py-4 whitespace-nowrap">無名</td>
              <td class="px-5 py-4 whitespace-nowrap">預約成功</td>
